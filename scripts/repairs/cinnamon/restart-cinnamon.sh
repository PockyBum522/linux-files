# Also try Ctrl + Alt + Esc for what might be a better cinnamon restart
...
echo ""
read -p "Press enter to continue when it is back up..."
...
/home/david/Desktop/move-windows-presets.sh
