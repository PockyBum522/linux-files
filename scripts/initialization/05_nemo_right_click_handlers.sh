...
curl $RES_GITHUB/icons/rider.svg > /home/$USER/.local/share/icons/rider.svg
...
curl $RES_GITHUB/nemo_actions/rider-open-folder.nemo_action > /home/$USER/.local/share/nemo/actions/rider-open-folder.nemo_action
